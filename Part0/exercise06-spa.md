...
sequenceDiagram
    ...
    Note right of browser: This request contains new note as JSON data containing both the content of the note (content) and the timestamp (date),ie   content: "single       page app reloads the whole page", date: "2019-05-25T15:15:59.905Z".
